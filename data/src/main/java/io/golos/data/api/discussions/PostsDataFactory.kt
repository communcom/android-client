...
internal object PostsDataFactory {
    ...
    fun createPost(body: String, community: CommunityDomain, userId: String, commentsCount: Int, permlink: Permlink): PostDiscussionRaw =
        PostDiscussionRaw(
            ...
            DiscussionId(CyberName(userId), community.communityId.code, Permlink.generate().value),
            CyberCommunity(community.communityId.code, community.name, community.avatarUrl, "alias", true),
