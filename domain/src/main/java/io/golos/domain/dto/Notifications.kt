...
data class MentionNotificationDomain(override val id: String,
                                     override val type: NotificationTypeDomain,
                                     override val isNew: Boolean,
                                     override val createTime: Date,
                                     override val lastNotificationTime: String): BaseNotificationDomain(id, type, isNew, createTime, lastNotificationTime)

data class ReplyNotificationDomain(override val id: String,
                                   override val type: NotificationTypeDomain,
                                   override val isNew: Boolean,
                                   override val createTime: Date,
                                   override val lastNotificationTime: String): BaseNotificationDomain(id, type, isNew, createTime, lastNotificationTime)
...
data class UpVoteNotificationDomain(override val id: String,
                                   override val type: NotificationTypeDomain,
                                   override val isNew: Boolean,
                                   override val createTime: Date,
                                   override val lastNotificationTime: String): BaseNotificationDomain(id, type, isNew, createTime, lastNotificationTime)
