package io.golos.cyber_android.ui.screens.wallet.model.lists_workers.history

import android.annotation.SuppressLint
import android.content.Context
import io.golos.cyber_android.R
import io.golos.cyber_android.ui.screens.wallet.dto.history.*
...
constructor(
    ...
    private fun getSeparator(localNow: DateCommonBase, server: DateCommonBase) =
        when {
            ...
            else -> WalletHistorySeparatorListItem(type = WalletHistorySeparatorType.PREVIOUSLY)
        }
