...
@SubFragmentScope
interface ProfilePostsExternalUserFragmentComponent {

    @Subcomponent.Builder
    interface Builder {
        fun init(module: ProfilePostsFragmentModule): Builder
        fun build(): ProfilePostsExternalUserFragmentComponent
    }

    fun inject(fragment: ProfilePostsExternalUserFragment)
}