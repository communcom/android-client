...
class ProfileExternalUserFragment : ProfileFragment() {
    ...
    override fun getCommunitiesFragment(sourceData: ProfileCommunities): Fragment =
        ProfileCommunitiesExternalUserFragment.newInstance(sourceData)

    override fun getFollowersFragment(filter: FollowersFilter, mutualUsers: List<UserDomain>): Fragment =
