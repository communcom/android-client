package io.golos.cyber_android.ui.screens.login_sign_in_old.qr_code
...
import io.golos.cyber_android.ui.screens.login_sign_in_old.qr_code.detector.QrCodeDetector
import io.golos.cyber_android.ui.screens.login_sign_in_old.qr_code.detector.QrCodeDetectorErrorCode
...
class QrCodeSignInFragment : FragmentBase(), SignInChildFragment {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qrCodeDetector.setOnDetectionErrorListener { errorCode ->
            when (errorCode) {
                ...
                QrCodeDetectorErrorCode.DETECTOR_IS_NOT_OPERATIONAL -> setVisibilityMode(
    ...
    private fun requestCameraPermissions() = requestPermissions(arrayOf(Manifest.permission.CAMERA),
