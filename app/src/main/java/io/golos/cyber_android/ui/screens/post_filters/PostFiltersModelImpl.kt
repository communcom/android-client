...
class PostFiltersModelImpl @Inject constructor(
    private val postFiltersHolder: PostFiltersHolder
) : PostFiltersModel {
    ...
    override suspend fun updateOpenFeedType(feedType: PostFiltersHolder.CurrentOpenTypeFeed) {
        postFiltersHolder.updateOpenFeedType(feedType)
    }
