package io.golos.cyber_android.ui.screens.login_activity.signup.country
...
constructor(
    ...
    init {
        ...
        launch {
            ...
            modelCountries.fold({ countries.value = it }, { command.value = ShowMessageCommand(R.string.common_general_error )})
        }
    }
