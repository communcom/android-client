...
class ParagraphPostItem(paragraphBlock: ParagraphBlock, processor: MyFeedViewModelListEventsProcessor?) :
    BasePostBlockItem<ParagraphBlock, ParagraphWidget>(paragraphBlock, processor) {
